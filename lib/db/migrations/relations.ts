...
import { document, suggestion, user, chat, message, messageV2, stream, bucketsInStorage, s3MultipartUploadsPartsInStorage, s3MultipartUploadsInStorage, objectsInStorage, vote, voteV2 } from "./schema";
